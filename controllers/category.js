...
const createCategory = async (req, res) => {
  try {
    ...
    const mailOptions = {
      from: 'joao.ramires@academico.uncisal.edu.br',
      to: 'jlsramires8@gmail.com',
  ...
  try {
    ...
    if (updated) {
      ...
      const mailOptions = {
        from: 'joao.ramires@academico.uncisal.edu.br',
        to: 'jlsramires8@gmail.com',
        subject: 'Nova categoria atualizada',
        text: `Uma nova categoria foi atualizada no dia 23/11/2024: ${updatedCategory.name}`,
        html: `<p>Uma nova categoria foi atualizada no dia 23/11/2024: ${updatedCategory.name}</p>`,
      };
